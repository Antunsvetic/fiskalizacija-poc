 ...
 *         <element name="PrateciDokument" type="{http://www.apis-it.hr/fin/2012/types/f73}PrateciDokumentType"/>
...
@XmlRootElement(name = "PrateciDokumentiZahtjev")
public class PrateciDokumentiZahtjev {

    @XmlElement(name = "Zaglavlje", required = true)
    protected ZaglavljeType zaglavlje;
    @XmlElement(name = "PrateciDokument", required = true)
    protected PrateciDokumentType prateciDokument;
     ...
     * @return
     *     possible object is
     *     {@link PrateciDokumentType }
     *     
     */
    public PrateciDokumentType getPrateciDokument() {
     ...
     *     
     */
    public void setPrateciDokument(PrateciDokumentType value) {
