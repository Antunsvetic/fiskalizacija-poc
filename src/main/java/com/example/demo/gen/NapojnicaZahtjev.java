 ...
 *         <element name="Racun" type="{http://www.apis-it.hr/fin/2012/types/f73}RacunNapojnicaType"/>
...
public class NapojnicaZahtjev {
     ...
     * @return
     *     possible object is
     *     {@link RacunNapojnicaType }
     *     
     */
    public RacunNapojnicaType getRacun() {
        return racun;
    }
     ...
     *     
     */
    public void setRacun(RacunNapojnicaType value) {
        this.racun = value;
    }
