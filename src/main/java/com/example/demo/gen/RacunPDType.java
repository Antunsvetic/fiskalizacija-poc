...
public class RacunPDType {
    ...
    protected RacunPDType.PrateciDokument prateciDokument;
     ...
     * @return
     *     possible object is
     *     {@link RacunPDType.PrateciDokument }
     *     
     */
    public RacunPDType.PrateciDokument getPrateciDokument() {
     ...
     *     
     */
    public void setPrateciDokument(RacunPDType.PrateciDokument value) {
    ...
    public static class PrateciDokument {
         ...
         * This is why there is not a {@code set} method for the jirPDOrZastKodPD property.
         * 
         * <p>
